...
### :cloud: Cloud
- [Cloud Detection Lab - Configuring SIEM (Azure Sentinel), Creating Data Collection Rules in Sentinel Analytics, Generating Security Events, Querying Logs Using KQL, & Using Mitigation Techniques via MITRE ATT&CK Framework](https://github.com/pattytechuk/Sentinel1)
